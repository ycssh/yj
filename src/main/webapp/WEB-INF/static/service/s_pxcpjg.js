...
function doSearch(){
	...
	$("#mainGrid").datagrid("load",{
		filter:"type=2&deptId="+deptId+"&projectId"+projectId+"&classId="+classId
	});
//	refreshItem();
}
...
//	        {field:'majorName',title:'专业',width:40},
	        ...
	        {field:'pxzlpj',title:'培训质量评价（短训班/团青培训）满意率',width:40},
	        {field:'jxfw',title:'综合服务评价（教学服务）（短训班/团青培训）满意率',width:40},
	        {field:'zhfwpj',title:'综合服务评价（后勤）（短训班/团青培训）满意率',width:40},
	        {field:'ztpj',title:'总体评价（短训班/团青培训）满意率',width:40},
