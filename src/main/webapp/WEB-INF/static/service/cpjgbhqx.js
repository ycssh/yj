...
//	    	filter:"zbname="+$.trim($("#s_zbname").val())+"&field="+$.trim($("#s_field").val())
	    ...
	    columns:[[
	        ...
	        {field:'pxzl',title:'培训质量评价（新员工培训）满意率',width:80},
	        {field:'jxfw',title:'综合服务评价（教学服务）（新员工培训）满意率',width:80},
	        {field:'hqfw',title:'综合服务评价（后勤服务）（新员工培训）满意率',width:80},
	        {field:'ztpj',title:'总体评价（新员工培训）满意率',width:80},
